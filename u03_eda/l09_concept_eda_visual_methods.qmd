...
*The things to retain -- these feed the retrieval quiz on this lesson, given at the start of L10.*

- **Reading a scatter:** direction / form / strength, and why the picture beats the number alone 
- **The Pareto cumulative line:** what "the vital few" means and how the sort makes it visible 
- **Reading a time plot:** telling trend from seasonality from a one-off spike 
- **Choosing a plot:** match a described question to the right picture (incl. many-variable views) 
