...
::: {.column-margin}
**Interactive alternatives.** This course plots with matplotlib and seaborn, which produce *static*
figures. [Plotly](https://plotly.com/python/) and [Altair](https://altair-viz.github.io/) build the
same chart types with hover, zoom, and selection instead. Useful while exploring; a static figure is
still what belongs in a report.
:::
